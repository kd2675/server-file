package com.example.file.api.image.biz;

import jakarta.servlet.http.HttpServletRequest;
import lombok.extern.slf4j.Slf4j;
import org.example.core.utils.ImageUtils;
...
public class ImageService {
    ...
    final int[] PHOTO_HEIGHT = {100, 200, 400, 800};
    final int[] PHOTO_WIDTH = {100, 200, 400, 800};
    ...
    public Map<String, Object> upload(MultipartFile file, HttpServletRequest request) {
        ...
        String postUrl = "image" + File.separator + "show" + File.separator + fileName;
        String pathUrl = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + File.separator + postUrl;
    ...
    public String saveImage(MultipartFile file){
        ...
        String uploadFileName = strToday + "_" + uuid.split("-")[0];
    ...
    public String updateImage(MultipartFile file, String deleteFileName){
